...
class History(models.Model):
    ...
    srcFilePath = models.CharField(max_length=256)
    destFilePath = models.CharField(max_length=256)
    thumnail = models.CharField(max_length=256,default=u"")
    result = models.CharField(max_length=32)
    category = models.CharField(max_length=32,default=1)
